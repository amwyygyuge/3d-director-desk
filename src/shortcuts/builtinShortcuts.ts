...
export const SHORTCUT_ID = {
    ...
    SURFACE_SNAP_TOGGLE: "gizmo.surface-snap",
...
export const SHORTCUT_SPECS: readonly {
    ...
    { id: SHORTCUT_ID.SURFACE_SNAP_TOGGLE, chords: ["v"], scope: "selected", label: "贴面吸附开关" },
...
const SHORTCUT_ACTIONS: Record<ShortcutId, (stores: DirectorDeskStores) => void> = {
    ...
    [SHORTCUT_ID.SURFACE_SNAP_TOGGLE]: (s) =>
        s.ui.setSuccessNotice(s.ui.toggleSurfaceSnap() ? "贴面吸附:开(水平拖动吸到下方站面)" : "贴面吸附:关"),
