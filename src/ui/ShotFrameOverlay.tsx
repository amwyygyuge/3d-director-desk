...
export const ShotFrameOverlay = observer(function ShotFrameOverlay() {
    ...
    return (
        <div data-helper="shot-frame" className="pointer-events-none absolute inset-0 z-[1]">
            ...
            <div className="absolute top-3 bottom-3 border-l border-white/25" style={{ left: `calc(0.75rem + (100% - 1.5rem) / 3)` }} />
            <div className="absolute top-3 bottom-3 border-l border-white/25" style={{ left: `calc(0.75rem + (100% - 1.5rem) * 2 / 3)` }} />
            <div className="absolute left-3 right-3 border-t border-white/25" style={{ top: `calc(0.75rem + (100% - 1.5rem) / 3)` }} />
            <div className="absolute left-3 right-3 border-t border-white/25" style={{ top: `calc(0.75rem + (100% - 1.5rem) * 2 / 3)` }} />
