...
const THREE_ADAPTER_FILES = [
    ...
    "src/command/**",
    "src/navigation/**",
    "src/core/ObjectMaterialRegistry.ts",
    "src/core/SceneManager.ts",
    "src/core/SelectionTintBinder.ts",
    ...
    "src/actor/ActorBuildBinder.ts",
    "src/actor/ActorRuntime.ts",
    "src/actor/ModelNormalizationPolicy.ts",
    "src/actor/rigMetrics.ts",
